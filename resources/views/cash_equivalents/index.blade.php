                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="form-group mb-3">
                                        <div class="custom-control custom-control-inline custom-radio">
                                            <input id="edit-radio-1-{{ $ce->id }}" type="radio" name="Mode" class="custom-control-input" value="1"
                                                {{ $ce->name === 'Regular Cash Equivalent' ? 'checked' : '' }}>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="type_of_account"
                                            ...
                                            class="form-control"
                                            required>
                                        <option value="" disabled {{ !$ce->type_of_account ? 'selected' : '' }}>Select Account Type</option>
                                        <option value="Peso Account" {{ $ce->type_of_account === 'Peso Account' ? 'selected' : '' }}>Peso Account</option>
...
document.addEventListener('DOMContentLoaded', function() {
    document.querySelectorAll('[id^="editCEModal"]').forEach(modal => {
        ...
        if (Object.values(specialNames).includes(nameInput.value)) {
            nameInput.readOnly = true;
        }

        // When user clicks a radio, update name
        radios.forEach(radio => {
            radio.addEventListener('change', function() {
