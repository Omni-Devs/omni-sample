            ...
            <form action="{{ route('components.update', $component['COMP_ID']) }}" method="POST">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <fieldset class="form-group" id="__BVID__3161">
                                            ...
                                            <div>
                                                <input type="text" placeholder="Enter Name of Component" class="form-control" aria-describedby="Name-feedback" label="Name" id="component_name" name="component_name" value="{{ $component['COMPONENT_NAME'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__3458">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" aria-describedby="Name-feedback" label="Name" id="category_id" name="category_id" value="{{ $component['CAT_ID'] }}"> 
                                                <div id="Name-feedback" class="invalid-feedback"></div>
                                                <!----><!----><!---->
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group" id="__BVID__9999">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" aria-describedby="Subcatid-feedback" id="sub_category_id" name="sub_category_id" value="{{ $component['SUBCAT_ID'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__408">
                                            ...
                                            <div>
                                                <input class="form-control" aria-describedby="Cost-feedback" id="component_cost" name="component_cost" value="{{ $component['COMPONENT_COST'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__408">
                                            ...
                                            <div>
                                                <input class="form-control" aria-describedby="Price-feedback" id="component_price" name="component_price" value="{{ $component['COMPONENT_PRICE'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__408">
                                            ...
                                            <div>
                                                <input class="form-control" aria-describedby="Unit-feedback" id="component_unit" name="component_unit" value="{{ $component['COMPONENT_UNIT'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__408">
                                            ...
                                            <div>
                                                <input class="form-control" aria-describedby="Onhand-feedback" id="onhand" name="onhand" value="{{ $component['ONHAND'] }}"> 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <fieldset class="form-group" id="__BVID__3658">
                                            ...
                                            <div>
                                                <input type="text" placeholder="Enter Name of Product" class="form-control" aria-describedby="Name-feedback" label="Name" id="__BVID__3659" value="Components"> 
                                                <div id="Name-feedback" class="invalid-feedback"></div>
                                                <!----><!----><!---->
                                            </div>
                                        </fieldset>
                ...
                {{-- <div class="mt-3 col-md-12">
                    <div class="form-group">
                        <label for="for_sale">
                            <input type="checkbox" id="for_sale" name="for_sale" value="1" {{ !empty($component['FOR_SALE']) && $component['FOR_SALE'] ? 'checked' : '' }}>
                            For Sale
                        </label>
                    </div> --}}
                    <div class="mr-2">
