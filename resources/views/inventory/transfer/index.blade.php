                        ...
                        <div class="vgt-responsive">
                            <table id="vgt-table"  class="table-hover tableOne vgt-table">
                                ...
                                <tr>
                                    ...
                                    <th scope="col" aria-sort="descending" aria-controls="col-1" class="vgt-left-align text-left w-220px sortable" style="min-width: auto; width: auto;"><span>Requested By</span> <button><span class="sr-only">
                                        Sort table by Requested By in descending order
                                        </span></button>
                                    </th>
                                ...
                                <tbody>
                                    <tr v-for="row in records" :key="row.id">
                                        ...
                                        <td class="vgt-left-align text-left w-220px">@{{ row.requested_by }}</td>
