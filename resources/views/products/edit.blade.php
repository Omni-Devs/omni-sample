                    ...
                    <span persist="true">
                        <fieldset class="form-group" id="__BVID__355">
                            ...
                            <div role="group" class="input-group">
                                <!----><input type="text" class="form-control" aria-describedby="Code-feedback" label="Code" id="product_code" name="product_code" value="{{ $product['PRODUCT_CODE'] }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <fieldset class="form-group" id="__BVID__358">
                                            ...
                                            <div>
                                                <input type="text" placeholder="Enter SKU" class="form-control" aria-describedby="Name-feedback" label="Name" id="product_code" name="product_code" value="{{ $product['PRODUCT_CODE'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__3161">
                                            ...
                                            <div>
                                                <input type="text" placeholder="Enter Name of Product" class="form-control" aria-describedby="Name-feedback" label="Name" id="product_name" name="product_name" value="{{ $product['PRODUCT_NAME'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__3458">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" aria-describedby="Name-feedback" label="Name" id="category_id" name="category_id" value="{{ $product['CAT_ID'] }}"> 
                                                <div id="Name-feedback" class="invalid-feedback"></div>
                                                <!----><!----><!---->
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="form-group" id="__BVID__9999">
                                            ...
                                            <div>
                                                <input type="number" class="form-control" aria-describedby="Subcatid-feedback" id="sub_category_id" name="sub_category_id" value="{{ $product['SUBCAT_ID'] }}"> 
                                        ...
                                        <fieldset class="form-group" id="__BVID__408">
                                            ...
                                            <div>
                                                <input class="form-control" aria-describedby="Price-feedback" id="product_price" name="product_price" value="{{ $product['PRODUCT_PRICE'] }}"> 
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <fieldset class="form-group" id="__BVID__408">
                                          <legend tabindex="-1" class="bv-no-focus-ring col-form-label pt-0" id="__BVID__408__BV_label_">SRP *</legend>
                                            <div>
                                                    <input class="form-control" aria-describedby="Price-feedback" placeholder="0" name="product_price" value="{{ $product['PRODUCT_PRICE'] }}"> 
                                                <div id="Price-feedback" class="invalid-feedback"></div>
                                                <!----><!----><!---->
                                            </div>
                                        </fieldset>
